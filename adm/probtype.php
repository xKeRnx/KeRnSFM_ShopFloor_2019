...
<?php include(__DIR__ . '/../Include/navbar.php'); ?>
			...
			<div class="header">
				<div class="header-content">
					<div class="page-title"><i class="icon-display4"></i> <?php echo getlang('problem_description'); ?></div>	
					<ul class="breadcrumb">
					<?php
					if(isset($_GET["id"])){
						echo '<li><a href="'.$_SITEURL.'adm">'.getlang('home').'</a></li>';
						echo '<li><a href="'.$_SITEURL.'adm/probtype">'.getlang('problem_description').'</a></li>';
						echo '<li class="active">'.getlang('change').'</li>';
					}else{
						echo '<li><a href="'.$_SITEURL.'adm">'.getlang('home').'</a></li>';
						echo '<li class="active">'.getlang('problem_description').'</li>';
					}
					?>					
					</ul>	
				</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title"><?php echo getlang('problem_description'); ?></h5>						
							</div>
							<div class="m-t-20">
								<?php
								if(isset($_POST['save'])) {
									$stmt = $conn->prepare("UPDATE problem_type SET name = ?, enabled = ? WHERE id = ?");
								...
								$Sel0stmt = $conn->prepare("SELECT * FROM problem_type WHERE id = ?");
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title"><?php echo getlang('problem_description'); ?></h4>
							</div>
							<div class="modal-body">	
								...
								<div class="form-group">
									...
									<div class="col-lg-8" style="padding-bottom: 10px;">
										<input type="text" id="newprobtype" class="form-control" placeholder="<?php echo getlang('name'); ?>" autocomplete="off">
									</div>
								</div>	
								...
								<script>
									function ajaxSave() {
										var newprobtype = document.getElementById('newprobtype').value;
										...
										if (newprobtype == ""){
											...
											data.append('newprobtype', newprobtype);
										
											var xhr1 = new XMLHttpRequest();
											xhr1.open('POST', '../adm/ins/newprobtype.php', true);
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-flat">
							...
							<table class="table table-hover invoice-list" id="datatable">
								...
								<tbody>
								<?php
								$sql = "SELECT * FROM problem_type ORDER BY name ASC";
									...
									while($row = $result->fetch_assoc()) {
										...
										echo '<tr>';
											...
											echo '<td class="text-center">
												<ul class="icons-list">
													<li><a href="'.$_SITEURL.'adm/probtype?id='.$entryid.'" ><i class="icon-eye2"></i></a></li>
												</ul>
											</td>
										</tr>';
									}
