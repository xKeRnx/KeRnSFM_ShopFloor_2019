...
<?php include(__DIR__ . '/../Include/navbar.php'); ?>
			...
			<div class="header">
				<div class="header-content">
					<div class="page-title"><i class="icon-display4"></i> <?php echo getlang('project'); ?></div>	
					<ul class="breadcrumb">
					<?php
					if(isset($_GET["id"])){
						echo '<li><a href="'.$_SITEURL.'adm">'.getlang('home').'</a></li>';
						echo '<li><a href="'.$_SITEURL.'adm/project">'.getlang('project').'</a></li>';
						echo '<li class="active">'.getlang('change').'</li>';
					}else{
						echo '<li><a href="'.$_SITEURL.'adm">'.getlang('home').'</a></li>';
						echo '<li class="active">'.getlang('project').'</li>';
					}
					?>					
					</ul>	
				</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title"><?php echo getlang('project'); ?></h5>						
							</div>
							<div class="m-t-20">
								<?php
								if(isset($_POST['save'])) {
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-flat">
							...
							<div class="m-t-20">
								<?php
								$sql = "SELECT * FROM project ORDER BY deadline DESC";
								...
								if ($result->num_rows > 0) {
									...
									while($row = $result->fetch_assoc()) {
										...
										echo '<tr>
											<td>'.$i.'</td>
											<td><a href="'.$_SITEURL.'adm/project?id='.$projid.'">'.$projcomp.' - '.$projname.'</a></td>
											<td>
												'.$projstart.'
											</td>													
											<td>
											...
											<td class="text-center">
												<ul class="icons-list">
													<li><a href="'.$_SITEURL.'adm/project?id='.$projid.'" ><i class="icon-eye2"></i></a></li>
												</ul>
											</td>
											</tr>';
									}
